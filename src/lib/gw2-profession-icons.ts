/** Iconos PNG oficiales de profesión (GW2 API / render.guildwars2.com). */
export const GW2_PROFESSION_ICONS: Record<string, string> = {
...
export function getProfessionIconUrl(profession: string): string | undefined {
  return GW2_PROFESSION_ICONS[profession.trim().toLowerCase()];
}

export function formatProfessionLabel(profession: string): string {
